Implement aspects and JavaMOP extended regular expressions (ERE) for a Transaction class. This class implements the following 3 methods: Start, Commit, and Modify.
